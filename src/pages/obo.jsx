...
import oboLogo from './img/oboLogo.svg'
import downArrow from './img/arrow-down.svg'
import bg from './img/oboBG.png'
import targetAudience from './img/targetAudience.png'
import competitors from './img/competitors.png'
import affinitizing from './img/affinityOne.png'
...
import routineOne from './img/routineOne.png'
import routineTwo from './img/routineTwo.png'
import oboHub from './img/oboHub.png'
import oboLogoWithBuilt from './img/oboLogo+.png'
import dailyChallenges from './img/dailyChallenges.png'
  ...
  return (
    <div className="App">
      ...
      <div className="textPadding sectionTop">
        <h1>The problem</h1>
        <h3 className="paragraphWidth oboParagraph">It is crucial to form genuine connections in order to develop healthy social skills, but physical, mental and emotional diabilities can make it extremely difficult.</h3>
        <h2 style={{fontWeight:"900", marginTop:"115px"}}>
          Understanding our target audience
            </h2>
        <img src={ targetAudience } className="targetAudience" alt="target  audience"/>
          </div>
          ...
          <div className="textPadding sectionTop">
            ...
            How Might We:<br/></h2>
            <h3 className="oboParagraph paragraphWidth">Make interaction between kids more natural?
            Reduce the uncomfortable experiences within a conversation?
            Make sincere social situations with or without human interaction?
            </h3>
              </div>
...
<div className="textPadding sectionTop">
  ...
  <img src={ competitors } className="competitors" alt="target  audience"/>
    ...
    <p className="oboParagraph">
      The privacy of customized usernames and avatars<br/>
      Very friendly. Everyone can use it just by talking to it<br/>
      Considering the parent when designing for children<br/>
      Makes education fun and kids feel comfortable<br/>
        </p>
        </div>
    ...
    <p className="oboParagraph">
      Doesn't provide a private way for meaningful conversation<br/>
      It's hard to communicate sometimes<br/>
      Doesn't make the meeting process less intense for the children<br/>
      Encourages kids to be comfortable talking to a robot - not to others<br/>
        </p>
    ...
    <div className="textPadding sectionTop">
      <h1>Interviews</h1>
      <h3 className="oboParagraph paragraphWidth">
        <strong>Challenge:</strong> My team had a hard time trying to reach out to kids to conduct interview, especially those who are diagnosed with social anxiety. Therefore, we got in touch with professionals who work closely with children.<br/><br/>
        <strong>Interviewees:</strong> Special Education Teacher • Speech Teacher • Parents<br/> <br/> <br/> <br/>
        <h2>Insights:</h2>
          </h3>
        </div>
  ...
  <ThreeColumns style={{lineHeight:"1.4"}} className="textPadding">
    <div>
      ...
      <div className="textPadding sectionTop">
        ...
        <h2 style={{textAlign:"left",lineHeight:"2.4"}}>
          • Wearable product that would help kids to connect with other kids through a "tap"<br/>
          • Social Robot that would help kids to practice communication and social skills<br/>
      ...
      <p className="oboParagraph paragraphWidth">
        ...
        <h3 className="steps">
          Step One <img style={{width:"50%",margin:"auto"}} src={ stepOne } className="steps" alt="step one"/>
            </h3>

            <h3 className="steps">
              Step Two <img style={{width:"50%",margin:"auto"}} src={ stepTwo } className="steps" alt="step one"/>
                </h3>

              <h3 className="steps">
                Step Three <img style={{width:"50%",margin:"auto"}} src={ stepThree } className="steps" alt="step one"/>
                  </h3>

              <h3 className="steps">
                Step Four <img style={{width:"25%",margin:"auto"}}src={ stepFour } className="steps" alt="step one"/>
                  </h3>
          </div>
    ...
    <div style={{marginTop:"75px"}} className="sectionTop textPadding">
      ...
      <img style={{width:"100%",margin:"auto"}}src={ wireframes } className="wireframes" alt="wireframes"/>
      <h3>
        Routines • Mid-fi
          </h3>
      <img style={{width:"50%"}}src={ routineOne } className="routine-mid" alt="routine"/>
      <img style={{width:"50%"}}src={ routineTwo } className="routine-mid" alt="routine"/>

      <h3 style={{marginTop:"50px"}}>
        Obo Hub
          </h3>
      <img style={{width:"100%",margin:"auto"}}src={ oboHub } className="oboHub" alt="obo hub"/>
        </div>
      ...
      <div style={{marginTop:"75px"}} className="textPadding sectionTop">
        ...
        <h2 style={{fontWeight:"900", marginTop:"35px"}}>
          Parent App
            </h2>
          </div>
      <ProjectsWrapper className="textPadding">
      ...
      <p className="oboParagraph">
        Buttons were obviously clickable<br/>
        Instructional pages on side features were helpful<br/>
      ...
      <p className="oboParagraph">
        ...
        Too much information on the main screen<br/>
      ...
      <h2 style={{marginTop:"75px", fontWeight:"900",}}>
         Obo Hub
          </h2>
            </div>
      ...
      <ProjectsWrapper className="textPadding">
        ...
        <p className="oboParagraph">
        ”Daily challenges” created small goal from kids to complete<br/>
        Kids were excited about multi-players games<br/>
        ...
        <p className="oboParagraph">
        Some of the “daily challenges” were a little too hard<br/>
        The games don’t indicate 2 or more players game<br/>
      ...
      <div className="textPadding sectionTop">
      <h1>Final Product</h1>
      <img style={{width:"25%"}}src={ oboLogo } className="oboTwo" alt="obo"/>
      ...
      <ProjectsWrapper className="textPadding">
        ...
        <div>
        <img style={{width:"100%"}}src={ dailyChallenges } className="dailyChallenges" alt="daily challenges"/>
        </div>
      </ProjectsWrapper>

      <ProjectsWrapper className="textPadding">
      <div>
      <img style={{width:"100%"}}src={ games } className="games" alt="games"/>
      </div>
      ...
      <div className="textPadding sectionTop">
        <h2 style={{textAlign:"center",marginTop:"100px"}}>Without Obo:</h2>
        <h3 style={{lineHeight:"2.0",textAlign:"center"}}>
          Kids don't know how to start a conversation<br/>
          Kids don't feel calm talking to others<br/>
...
<ColoredLine color="#c0c0c0" />
        ...
        <div style={{marginTop:"100px"}} className="textPadding sectionTop">
          <h1>Parent App</h1>
          <h3>On boarding</h3>
          <img style={{width:"100%"}}src={ onBoarding } className="onBoarding" alt="on boarding"/>
            </div>

            <ThreeColumns style={{lineHeight:"1.4"}} className="textPadding">
              <div>
                <img style={{width:"100%"}}src={ homeScreen } className="homeScreen" alt="home screen"/>
                <p>
                  ...
                  <div>
                    <img style={{width:"100%"}}src={ routinesScreen } className="homeScreen" alt="home screen"/>
                    <p>
                      ...
                      <div>
                        <img style={{width:"100%"}}src={ digitalBalance } className="homeScreen" alt="home screen"/>
                        <p>
                ...
                <div className="textPadding sectionTop">
                  <h2 style={{textAlign:"center",marginTop:"100px"}}>Without Obo:</h2>
                  <h3 style={{lineHeight:"2.0",textAlign:"center"}}>
                    Parents won't be able to look after their child without hovering<br/>
                    Parents don't know how their child is feeling<br/>
